# Source : https://www.quadrotech-it.com/blog/set-language-and-time-zone-for-all-owa-users-in-office-365/
...
Get-Mailbox | Set-MailboxRegionalConfiguration -Language 1033 -TimeZone "GMT Standard Time"